        ...
        arrayName.forEach((item) => {
            ...
            workerCard.innerHTML = `
                <div onclick="indoforall_showCardsDetails( '${cardCounter}', '${workerImg}', '${workerVideo}');">
                    ...
                    <img src=${workerImg} alt="استقدام من اندونيسيا - اندو للجميع" title="استقدام من اندونيسيا - اندو للجميع" class="indoforall_animate_on_scroll">
                </div>
            `;
...
if (document.getElementById("indoforall_question_area")) {
    indoforall_questionAndAnswerArray.forEach((item) => {
        ...
        indoforall_QuestionDiv.innerHTML = `
            <h2 class="indoforall_QuestionText indoforall_animate_on_scroll">${questionText}</h2>
            <h3 class="indoforall_AnswerText indoforall_animate_on_scroll">${answerText}</h3>
    `;
...
if (document.getElementById("indoforall_proof_area")) {
    indoforall_proofVideosArray.forEach((item) => {
        ...
        ProofVideoDiv.classList.add("indoforall_worker_proof_card");

        /* Check If The Object Has 'imgSrc' Or 'videoSrc' And Based On it, It Will Show Different Code */
        if (imgSrc) {
            ProofVideoDiv.innerHTML = `
            <h2 class="indoforall_animate_on_scroll">${cardCounter}</h2>
            <img src=${imgSrc} alt="استقدام من اندونيسيا - اندو للجميع" title="استقدام من اندونيسيا - اندو للجميع" onclick="indoforall_show_full_screen_image(this.src)" class="indoforall_animate_on_scroll">
        `;
        } else if (videoSrc) {
            ProofVideoDiv.innerHTML = `
            <h2 class="indoforall_animate_on_scroll">${cardCounter}</h2>
            <video src=${videoSrc} controls title="استقدام من اندونيسيا - اندو للجميع" class="indoforall_animate_on_scroll"></video>
        `;
        ...
        // Add horizontal scrolling functionality
        document.getElementById("indoforall_proof_area").addEventListener("mousedown", function (event) {
            if (event.button === 0) {
                // Check if left mouse button is clicked
                this.classList.add("grabbing"); // Add grabbing cursor style
                this.dataset.scrollX = this.scrollLeft; // Store initial scrollLeft position
...
if (document.getElementById("indoforall_ads_videos_and_img_div")) {
    indoforall_adsVideosArray.forEach((item) => {
        ...
        `;
            ...
            AdsVideoInfo = `
                <img src=${videoThumbnailSrc} alt="استقدام من اندونيسيا - اندو للجميع"  title="استقدام من اندونيسيا - اندو للجميع" class="indoforall_ads_thumbnail_img indoforall_animate_on_scroll">
                <video src=${videoSrc} controls title="استقدام من اندونيسيا - اندو للجميع" class="indoforall_ads_orignal_video indoforall_animate_on_scroll"></video>
            `;
...
/* in Case if The Element With The Id 'indoforall_nav' Exist Then Do The Following Codes */
...
document.addEventListener("DOMContentLoaded", () => {
    const animatedElements = document.querySelectorAll(".indoforall_animate_on_scroll");
